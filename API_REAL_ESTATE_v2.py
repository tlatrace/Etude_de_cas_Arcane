...
#la v2 a pour objectif de sécuriser notre API REST avec le module flask_httpauth
...
#fonction callback utilisée pour obtenir le mot de passe d'un user d'une database
@auth.get_password
def get_password(username):
    if username == 'thibault':
        return 'python'
    return None
